    ...
    <>
      ...
      <div className="Firstmaincontainer">
        <div className="Main-Container">
          <div className="container-1">
            ...
            <div className="Main-Container">
              <div className="mylibrary">
                <div className="mainheading">
                  <h1 className="library-heading">Topic</h1>
                </div>
              </div>
            </div>
            <div className="persentage2">
            ...
            <div className="persentage2 ">
              ...
              <div className="new-box">
                ...
                <h1
                  className="text-for-peresantage"
                  style={{ fontSize: "16px" }}
                >
                  Lorem ipsum
                </h1>
        ...
        /> */}
            ...
            <section>
              <div className="card-for" style={{ marginBottom: "32px" }}>
                <h1 className="blog-heading">Blogs</h1>
                <div className="Icon-in-card">
                  <img
                    src="/images1 .png"
